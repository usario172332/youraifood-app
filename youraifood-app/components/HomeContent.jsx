      ...
      <section className="px-6 pb-6">
        <div className="mx-auto max-w-[1120px] text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-xs text-ink-soft">
            🔍 Nutritional values are calculated directly from the ingredients and serving sizes in our recipe database rather than generated by AI. Actual values may vary depending on ingredient brands and preparation methods.
          </p>
        </div>
      </section>
