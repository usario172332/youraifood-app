...
const ROWS = [
  {
    generic: 'Suggests individual recipes, one at a time',
    us: 'Builds every recipe around your specific goal',
  },
  {
    generic: "Doesn't give you a structured weekly plan",
    us: 'Creates a complete 7-day meal plan, every time',
  },
  {
    generic: 'You write your own shopping list',
    us: 'Generates the shopping list for you, automatically',
  },
  {
    generic: 'Not built for nutrition tracking',
    us: 'Calculates real calories, protein and macros for every meal',
  },
  {
    generic: 'Stops at giving you ideas',
    us: 'Connects the full journey — from "what should I eat" to what to buy',
  },
];
    ...
    <section className="bg-gray-50 px-6 py-16">
      <div className="mx-auto max-w-[1120px]">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-extrabold text-green-900">Why YourAiFood?</h2>
          ...
          <p className="mx-auto mt-3 text-ink-soft">
            A general AI chatbot can hand you a recipe. YourAiFood is purpose-built to take you all the way from a
            goal to a finished grocery list — with real nutrition numbers, not guesses.
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-1 gap-y-4">
          {JOURNEY.map((step, i) => (
            <div key={step.label} className="flex items-center gap-1">
              <div
                className={`flex w-[108px] flex-col items-center gap-1 rounded-2xl border px-3 py-4 text-center ${
                  step.soon ? 'border-dashed border-gray-300 bg-white' : 'border-green-200 bg-green-50'
                }`}
              >
        ...
        <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-2xl border border-gray-200 bg-white">
          <div className="grid grid-cols-2 bg-gray-50 text-sm font-extrabold">
            <div className="border-r border-gray-200 px-5 py-3 text-gray-500">A generic AI assistant</div>
