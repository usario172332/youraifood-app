...
// Mirrors generate-plan/route.js's enforceCalorieTarget, scoped to a single
// day rather than a whole week — bumps the lowest-scaled dish's servings
// tier until the day clears 90% of the calorie target or all dishes maxed.
...
// These two duplicate generate-plan/route.js's grocery/stats builders since
// they aren't exported from there — both operate on the FULL 7-day array
// because groceries and week-wide stats always need to reflect every day,
// not just the one being swapped.
...
// Regenerates a single day of an already-generated weekly plan. Reuses the
// same free-plan monthly counter as generate-plan (a day regen still costs a
// real AI call), and recomputes groceries/stats across the FULL updated
// 7-day set since those are week-wide aggregates, not per-day.
